...
<div id="customer">
        <div id="head">
           <h2>Cập nhật thông giới thiệu</h2>
           <span><?php if(!empty($er)) echo $er; else echo "Vui lòng điền đầy đủ thông tin dưới đây"; ?></span>
        </div>
        <div id="form">
<form method="post" action="">
    <fieldset><legend>Cập nhật thông tin giới thiệu</legend>
<table>
    <tr>
        <td>Nội dung:</td>
    <td>
        <textarea  class="ckeditor" name="value"><?php if(isset($_POST['value']))echo $_POST['value']; else echo $data['intro_content']; ?></textarea><span style="color: red">* <?php echo$error;?></span>	
    </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
