 ...
 <div id="error">
      <?php 
           ...
           if(isset($_POST['ok'])){               
               ...
               $end=$_POST['end'];
               $notice=$_POST['notice'];
               if($pro_id==null||$pro_price==NULL||$pro_gia==null||$start == ""||$end ==""){
                            ...
                            if($exist){
                               ...
                               if(strtotime($start) > strtotime($end)){
                                 $er= 'Ngày kết thúc trước ngày bắt đầu';
                                  ...
                                  if($sales->update($id,$pro_id, $pro_price, $pro_gia, $start, $end, $notice)){
                                      $er= 'Thành công';
                                      $_POST['pro_id']="";
...
<form action="" method="post">
    <fieldset><legend>Cập nhật sản phẩm</legend>
    <table>
        <tr>
            <td>Mã sản phẩm :</td>
            <td><input  class="sale" type="text" name="pro_id" id="proid" value="<?php 
            if(isset($_POST['pro_id'])) echo $_POST['pro_id']; else echo $data['pro_id'];
        ...
        <tr>
            ...
            <td><input type="text" name="sa" class="sale"
                       value="<?php if(isset($_POST['sa'])) echo $_POST['sa'];else echo $data['sale_percent']; ?>"
                       ><span id="error1" style="color: red;">*<?php echo $price_error;?></span></td>
        </tr>
        <tr  id="Km"  style="display: none;">
            <td >Giá khuyến mãi:</td>
            <td ><input type="text" readonly="true" value="<?php echo $data['sale_price'];?>" id="result" name="giakhuyenmai"/></td>
        </tr>
        <tr>
            <td>Ngày bắt đầu :</td>
            <td><input type="text" class="datepicker"  name="start" value="<?php if (isset($_POST['start'])) echo $_POST['start'];else echo $data['sale_start']; ?>"><span style="color: red;">*</span></td>
        </tr>
        <tr>
            <td>Ngày kết thúc :</td>
            <td><input type="text" class="datepicker" name="end" value="<?php if(isset($_POST['end'])) echo $_POST['end']; else echo $data['sale_end']; ?>"><span style="color: red;">*</span></td>
        </tr>
        <tr>
        <td>Ghi chú :</td>
        <td><textarea name="notice" cols="10" rows="9"><?php if(isset($_POST['notice'])) echo $_POST['notice'];else echo $data['sale_notice']; ?></textarea></td>
        </tr>
        <tr>
            <td></td>
            <td style="padding-left: 100px;"><input type="submit" value="Cập nhật" name="ok" style="height: 50px; width: 110px;"></td>
        </tr>
    </table>
    </fieldset>
</form>
       ...
       <div id="search">
             ...
             <form>
                 <table>
                     ...
                     <tr><td><input type="button" value="Tra cuu" id="tim"></td></tr>
                 </table>
             </form>
             </div>
             <div id="re">
